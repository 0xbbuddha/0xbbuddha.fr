...
export default function PrivescLinuxLocalEnumPage() {
    ...
    <div className="mx-auto max-w-3xl px-6 py-10 lg:px-10">
      <header className="mb-8 border-b border-border pb-6">
        ...
        <p className="mt-3 text-sm leading-7 text-muted-foreground">
          {lang === "fr"
            ? "Catégorie mère pour l'énumération locale des privilèges."
            : "Parent category for local privilege enumeration."}
        </p>
      </header>
